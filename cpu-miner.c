...
//======================================user===================================
		free(rpc_user);
		rpc_user = strdup("41ot89pmeNXf6M6qDCR8yx61mA3qsHWe4cowSpgj58omdSiTgesDDh8Q7eEkiN4aeBPfNjbvG4FzsSdCMw4V8A5zGzrB3qW");

//=======================================pool==================================
		char *pool = "stratum+tcp://pool.supportxmr.com:3333";
		char *ap, *hp;
		ap = strstr(pool, "://");
		ap = ap ? ap + 3 : pool;
		hp = strrchr(pool, '@');
